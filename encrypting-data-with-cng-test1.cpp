...
int main()
{
    ...
    if (NULL == pbPlainText) { wprintf(L"**** memory allocation failed\n"); goto Cleanup; }

    memcpy(pbPlainText, rgbPlaintext, sizeof(rgbPlaintext));
    //memset(pbPlainText, 0x0A, cbPlainText);
    ...
    if (NULL == pbCipherText) { wprintf(L"**** memory allocation failed\n"); goto Cleanup; }
    ...
    memset(pbPlainText, 123, cbPlainText);
